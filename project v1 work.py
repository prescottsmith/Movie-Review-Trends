...
imdb = pd.read_csv('imdb_raw.csv', encoding = "ISO-8859-1").copy()

sns.set(style="white")

df_imdb = (pd.read_csv('Data/project v1 data/imdb_chart.csv').copy())
df_rt = (pd.read_csv('Data/project v1 data/rt_chart.csv').copy())
df_mc = (pd.read_csv('Data/project v1 data/mc_chart.csv').copy())
